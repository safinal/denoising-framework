...
from src.defect_detection.evaluate import check_defect_detection_performance, defect_detection_k_fold_cross_validation
...
defect_detection_k_fold_cross_validation(defect_detection_dataset, defect_detection_criterion, experiment_logs_dir)
